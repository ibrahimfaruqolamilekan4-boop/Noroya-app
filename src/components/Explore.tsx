...
import { MasteryReciterStudio } from './MasteryReciterStudio';
...
export const Explore = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-16 islamic-pattern min-h-screen">
      ...
      {activeTab === 'tarteel' && (
        <section className="py-12">
          <MasteryReciterStudio ayahText="بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ الْحَمْدُ لِلَّهِ رَبِّ الْعَالَمِينَ الرَّحْمَٰنِ الرَّحِيمِ مَالِكِ يَوْمِ الدِّينِ" />
        </section>
      )}
